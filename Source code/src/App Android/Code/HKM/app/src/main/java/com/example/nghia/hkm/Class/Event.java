...
public class Event {
    ...
    public Event(String __Title__, String __Href__, String __HomePage__, String __LinkImage__, long __ViewCount__, long __LoveCount__, java.util.Date __DateInsert__, boolean __Delete__)
    {
        super();
