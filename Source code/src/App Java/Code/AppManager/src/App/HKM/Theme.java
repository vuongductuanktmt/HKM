...
public class Theme {
	 ...
	 */
	public Theme()
			throws UnknownHostException, HeadlessException,  InterruptedException {
		initialize();
	}
	...
	private void initialize()
		...
		comboBoxChangeTheme.setModel(new DefaultComboBoxModel(new String[] { "METAL", "FAST", "SMART", "ACRYL", "AERO",
				"BERNSTEIN", "ALUMINIUM", "MCWIN", "MINT", "HIFI", "NOIRE", "LUNA" }));
		...
		comboBoxChangeTheme.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (message.isOk) {
					...
					comboBoxChangeTheme.setSelectedItem(Login.cache_theme);
				}
			}
		});
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								.addGroup(groupLayout.createSequentialGroup().addComponent(lbChangeTheme).addGap(18)
										.addComponent(comboBoxChangeTheme, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addGroup(groupLayout.createSequentialGroup()
										.addComponent(lblLoadImage, GroupLayout.PREFERRED_SIZE, 93,
						...
						.addGroup(groupLayout.createSequentialGroup()
								...
								.addGap(18).addComponent(spinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(231, Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(35)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lbChangeTheme).addComponent(
						comboBoxChangeTheme, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE))
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addGap(20).addComponent(lblLoadImage,
								GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup().addGap(18).addComponent(comboBoxLoadImage,
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(spinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED, 110, Short.MAX_VALUE).addComponent(info).addGap(19)));
