...
public class Login {
	...
	public Login() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			UnsupportedLookAndFeelException, IOException, AccessException, MBeanException, InterruptedException {
						...
						if (password.isEmpty() || user.isEmpty()) {
							...
							try {
								...
								if (!request.equals("false")) {
									...
									CtS = new ClientToServer("last_login", "admin", user, extend.Token(password),
											security.getValue(Integer.parseInt(request)));
									if (CtS.getValueRequests().equals("true")) {
