...
public class ClientToServer {
	...
	public ClientToServer(String request, int pageSize, String authorities, String table, String search,
			String status) {
		super();
		this.Request = request;
		this.PageSize = pageSize;
	...
	public ClientToServer(String request, String authorities, String table, String var, String value, String condition,
			int search) {
		super();
	...
	public String getValueRequests() throws URISyntaxException, IOException {
		...
		request.put("__Request__", this.getRequest()); // thông tin reuest lên
														// server
		request.put("__User__", this.User); // thông tin user
		request.put("__Password__", this.Password); // thông tin password của
													// người dùng
		request.put("__Security__", this.Securitys); // Thông tin bảo mật
		request.put("__PageSize__", this.PageSize); // Số lượng record của 1
													// trang
